...
from app.views import auth_login, calendar, calendar_view, chats, manual_booking, public_calendar_entry, user_calendar, webhook

urlpatterns = [
    path('', calendar, name='calendar'),
    path('admin/', admin.site.urls),
    path('webhook/', webhook, name='webhook'),
    path('calendario/', public_calendar_entry, name='public_calendar_entry'),
    ...
    path('api/dashboard/chats/threads/', chat_threads_api, name='chat_threads_api'),
    path('api/dashboard/chats/<int:user_id>/messages/', chat_messages_api, name='chat_messages_api'),
    path('api/dashboard/chats/<int:user_id>/send/', chat_send_api, name='chat_send_api'),
    path('api/dashboard/chats/<int:user_id>/resolve/', chat_resolve_api, name='chat_resolve_api'),
    path('api/dashboard/chats/<int:user_id>/reopen/', chat_reopen_api, name='chat_reopen_api'),
    ...
    path('api/calendar/<uuid:token>/available-days/', dashboard_calendar_days_api, name='dashboard_calendar_days_api'),
